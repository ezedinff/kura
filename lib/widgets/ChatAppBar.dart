...
import 'package:kura/config/Assets.dart';
import 'package:kura/config/Palette.dart';

class ChatAppBar extends StatelessWidget implements PreferredSizeWidget {
  final double height = 100;
  @override
  Widget build(BuildContext context) {
    var textHeading = TextStyle( fontSize: 20); // Text style for the name
    var textStyle = TextStyle(); // Text style for everything else
